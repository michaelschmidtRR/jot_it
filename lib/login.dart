...
import 'package:jot_it/home.dart';
import 'package:jot_it/register.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  _body(BuildContext context, double width, double height) =>
      ...
      ListView(physics: BouncingScrollPhysics(), children: <Widget>[
        Container(
            ...
            child: Column(
                children: <Widget>[_formUI(width, height), _socialSignIn(width, height)]))
      ]);
  ...
  _formUI(double width, double height) {
